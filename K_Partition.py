######################################################
# K Partition algorithm to produce clusters given specific thresholds of cpu and ram usage
...
class K_Partition:
    def __init__(self, pod_request_cpu, pod_request_ram, service_affinities, max_ram_allocation, max_cpu_allocation,
